                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        //  console.log(response.data.customization_data.border_color);
                         ...
                         var popupForm = `<section id="popUpAddressForm" style="border-color: ${response.data.customization_data.border_color}; background-color: ${trim_color_inForm}; border-width: ${response.data.customization_data.border_width}; border-style: solid; border-radius: ${response.data.customization_data.corner_style === 'Square' ? '0' : '10px'};"><div class="scroll-right-prompt-popUpform"  style="background-color: ${trim_color_inForm};" ><div class="scroll-rshiping-adrs-bg" style="background-color: ${trim_color_inForm};"> <h5 class="popup-title" style="color: ${response.data.customization_data.text_color};">Suggested corrected prompts</h5> <div class="scroll-rshiping-adrs" style="color: ${response.data.customization_data.text_color};">
                       ...
                       if (typedRadio) {
                         ...
                         function saveChanges() {
                            ...
                            if (selectedAddress) {
                                ...
                                console.log(addressSectionDiv.length);
